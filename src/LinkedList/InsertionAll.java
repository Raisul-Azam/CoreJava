...
public class InsertionAll {
    ...
    void deleteNode(int position, int val){
        // linkedlist is empty
        if(head == null){
            return;
        }
    ...
    public static void main(String[] args) {
    	InsertionAll llist = new InsertionAll();
        llist.insertAtEnd(2);
        llist.insertAtEnd(4);
        llist.insertAtEnd(8);
        ...
        System.out.println("Insert any particular index: ");
       llist.insertAfter(llist.head.next.next.next, 13);
       llist.displayLL();
        System.out.println();

        llist.deleteNode(3,4);
...
//
//        System.out.println("Linked_List after successful insertion of all the nodes:");
//        llist.printNodes();
//        System.out.println();
//
//	}
